...
EXPECTED = {
    ...
    # 평일에 하루 두 번. 주말을 넘길 수 있으므로 넉넉히 잡는다.
    "stalled-work":  {"hours": 80, "why": "평일 하루 두 번"},
    # 10분마다 돌지만 대상이 없으면 그냥 끝난다. 한 시간 넘게 안 돌면
    # 작업창이 지나가는 동안 아무도 스냅샷을 안 찍고 있다는 뜻이다.
    "auto-snapshot": {"hours": 2, "why": "10분마다"},
